...
function logElements (passedArray = ["Nothing to log"]) {
...
function getUserName (passedObject = {name: "John Smith" }) {
    return passedObject["name"];

}

console.log(getUserName(MyObject = {name: "Bob Pussman" }));